            ...
            {weddingPage ?
                ...
                (
                    <div className="weddingContent">
                        ...
                        <h2>StyleMyOccasion helps people discover the perfect outfit for any celebration. We educate
                            users with simple tips, clear suggestions, and easy style guides that match each event.
                            Whether it’s a birthday, wedding, or casual party, we help you choose outfits that make you
                            feel confident and comfortable. If you have a dream outfit, tell us — we can help you bring
                            it to life.</h2>
                        {
