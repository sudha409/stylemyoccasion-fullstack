                    ...
                    { birthday ?
                        ...
                        (
                            <div className="birthdayContent">
                                ...
                                <h2>A birthday outfit should feel fun, bright, and full of celebration. This design focuses on soft colors, playful patterns, and comfortable pieces that make the birthday person feel special.The look blends style with joy, using light fabrics, cheerful accessories, and a touch of sparkle to create a perfect birthday vibe,A good outfit does more than make someone look nice — it actually helps people feel better, act more confidently, and express who they are,</h2>
                                {
                                    birthday.map((design) => (
